        ...
        <div className="container mt-3">
				...
				<div className="d-flex">
					<div className="p-2 flex-fill">
						<div className="form-check">
							...
							checked={gender == '1'} onChange={(e)=>setGender(e.target.value)}/>남성
							<label className="form-check-label" htmlFor="radio1"></label>
						</div>
					</div>
					<div className="p-2 flex-fill">
						<div className="form-check">
							<input type="radio" className="form-check-input" id="radio2" name="gender" value="2" checked={gender == '2'} onChange={(e)=>setGender(e.target.value)}/>여성
			...
			<div className="d-flex">
				<div className="p-2 flex-fill d-grid">
					<button className="btn btn-primary" onClick={()=>nav('/userview')}>가입</button>
				</div>
				<div className="p-2 flex-fill d-grid">
